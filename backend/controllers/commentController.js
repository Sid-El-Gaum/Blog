...
/**----------------------------------------
* @desc    Creae New Comment
* @route   /api/comments
* @method  POST
* @access  private  (only logged in user)
-------------------------------------------*/
module.exports.createcommentCtlr = asyncHandler(async(req,res)=>{
    // 1.Validate
...
-------------------------------------------*/
module.exports.deleteCommentsCtlr = asyncHandler(async(req,res)=>{
...
-------------------------------------------*/
module.exports.updateCommentCtlr = asyncHandler(async(req,res)=>{
    // 1.Validate
