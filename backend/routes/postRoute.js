...
const { createPostCtrl, getAllPostsCtrl, getSinglePostsCtrl, getPostsCountCtrl, deletePostsCtrl, updatePostCtrl, updatePostImageCtrl, toggelLikeCtrl } = require('../controllers/postcontroller.js');
